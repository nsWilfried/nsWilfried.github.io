    ...
    <section class="text-gray-600 body-font relative">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          ...
          >
            <span
              class="text-3xl text-red-400 pb-3"
        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
          <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full">
              <div class="relative">
                ...
                <textarea
                  ...
                  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-red-400 focus:bg-white focus:ring-2 focus:ring-red-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                ></textarea>
                <span class="pt-2 text-red-400">{{ errors.message }}</span>
              </div>
            </div>
            <div
              class="contact__button pt-6 bg--400 w-full flex justify-center"
            >
            ...
            >
              <a href="mailto:wacnsoukpoe@gmail.com" class="text-red-400"
                >wacnsoukpoe@email.com</a
              >
